...
"""Test the 7zzs program"""

from . import ArchiveTest, Content
from .. import needs_program, needs_codec


class Test7zzs(ArchiveTest):
    """Test class for the 7zzs program"""

    program = '7zzs'

    @needs_program(program)
    def test_7zzs(self):
        """Run archive commands with archives that 7zzs supports."""
    ...
    def test_7zzs_rar(self):
        """Run archive commands with RAR archives."""
        # only succeeds with the rar module for 7zzs installed
    ...
    @needs_program('file')
    @needs_program(program)
    def test_7zzs_file(self):
        """Run archive commands with renamed archives that 7zzs supports."""
...
class Test7zzsPassword(ArchiveTest):
    """Test class for the 7zzs program with password protected archives"""
    ...
    @needs_program(program)
    def test_7zzs(self):
        """Run archive commands with password protected archives for 7zzs."""
    ...
    @needs_program(program)
    def test_7zzs_file(self):
        """Run archive commands with renamed password protected archives for 7zzs."""
