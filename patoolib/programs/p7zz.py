...
extract_bzip2 = (
    extract_gzip
) = extract_compress = extract_xz = extract_lzma = extract_7z_singlefile
...
extract_zip = (
    ...
    extract_arj
) = extract_cpio = extract_rpm = extract_deb = extract_iso = extract_vhd = extract_7z
...
list_bzip2 = (
    ...
    list_cpio
) = list_rpm = list_deb = list_iso = list_xz = list_lzma = list_vhd = list_7z
...
test_bzip2 = (
    ...
    test_cpio
) = test_rpm = test_deb = test_iso = test_xz = test_lzma = test_vhd = test_7z
